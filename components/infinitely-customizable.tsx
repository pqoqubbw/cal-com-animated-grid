...
const InfinitelyCustomizable = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-auto flex items-center justify-center rounded-md transition-transform duration-300 ease-out group-hover:translate-x-[calc(var(--x)*5px)] group-hover:translate-y-[calc(var(--y)*5px)]">
            ...
            >
              ...
              <div className="radial-fadeout relative z-10 [--mask-distance:110px]">
                ...
                >
                  ...
                  <path
                    fill="#E5E7EB"
                    d="M155.68 241.953V60.999h.438v180.954z"
                  />
